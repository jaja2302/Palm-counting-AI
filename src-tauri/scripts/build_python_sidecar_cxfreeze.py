...
'''
    try:
        ...
        print("=" * 70 + "\n")
        if r.returncode != 0:
            print(f"❌ cx_Freeze build_exe failed (exit {r.returncode})")
            return False
    finally:
        if setup_py.exists():
    ...
    print(f"✓ Sidecar cx_Freeze OK: {out_path}")
...
def main():
    ...
    print("=" * 70)
    print("  💡 cx_Freeze + PyTorch/Ultralytics sering RecursionError. Coba:")
