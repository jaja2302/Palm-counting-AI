...
def build_python_sidecar():
    ...
    print("=" * 70)
    print("Building Python sidecar (infer_worker) with Nuitka")
    ...
    # Build infer_worker only (YOLO + PyTorch + CUDA)
    print("\n" + "=" * 70)
    print("Building infer_worker (YOLO + GPU)...")
    print("=" * 70)
    success = build_sidecar_nuitka("infer_worker.py", "infer_worker")
    ...
    if success:
        ...
        print("\n" + "=" * 70)
        print("✗ infer_worker failed to build!")
